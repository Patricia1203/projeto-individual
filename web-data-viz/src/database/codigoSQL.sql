...
CREATE TABLE pergunta (
    ...
    pergunta varchar(80) NOT NULL UNIQUE,
...
INSERT INTO quiz (titulo_quiz, id_regiao, descricao_quiz, nivel_dificuldade, total_pontos_possivel) VALUES
('Demacia: Conhecimentos Gerais', 1, 'Teste seu conhecimento sobre o reino de Demacia', 'Fácil', 112), -- 16 cada pergunta
('Noxus: História do Império', 2, 'Perguntas sobre a história e cultura de Noxus', 'Médio', 182), -- 26 cada pergunta
('Freljord: Tribos e Lendas', 3, 'Quiz sobre as tribos e lendas do Freljord', 'Difícil', 245), -- 245 cada pergunta
('Ionia: Magia e Natureza', 4, 'Conhecimentos sobre a espiritualidade de Ionia', 'Médio', 182), -- 26 cada pergunta
('Piltover & Zaun: Tecnologia', 5, 'Invenções e inovação nas cidades gêmeas', 'Fácil', 112); -- 16 cada pergunta
